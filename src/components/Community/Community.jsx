...
export const Community = () => {
  return (
    <>
      <div className='xs:bg-[#F8F9FC] xs:h-[400px] xs:text-black xs:text-4xl'>
      ...
      <div className="slider xs:flex xs:h-[200px] xs:w-[90%] xs:justify-center xs:mt-6 xs:space-x-2">
      ...
      <div className="connect xs:bg-[#004DB3] xs:h-[450px] text-white xs:text-center xs:pt-4 xs:space-y-1">
