    ...
    <div className='sticky top-0'>
      <div className="main-nav flex justify-between sm:flex sm:justify-between px-4 lg:px-16 py-8 ">
        ...
        <div className={`${navOpen ? 
          ...
          'fixed left-[-100%] z-20 top-0 w-[45%%] p-10 ease-in duration-700 bg-[#004DB3]'} nav-links lg:space-x-4 lg:flex text-sm text-gray-400 font-bold space-y-6  `}>
            
            <div>
              <Link to='#home' smooth className='flex justify-between items-center'>
                <a href='/' className='text-white'>Home</a>
                <FaXmark onClick={handleNavToggle} className=' cursor-pointer lg:hidden text-white h-8' />
              </Link>
              </div>
